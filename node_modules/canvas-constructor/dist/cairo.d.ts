...
import { Image as NativeImage, loadImage, registerFont as loadFont, type ImageData, type JpegConfig, type JPEGStream, type Canvas as NativeCanvas, type CanvasRenderingContext2D as NativeCanvasRenderingContext2D, type PDFStream, type PNGStream, type PdfConfig, type PngConfig, type TextMetrics } from 'canvas';
 ...
 * hex('0F0F0F'); // -> '#0F0F0F'
 */
export declare const hex: <T extends string>(hex: T) => ColorHexadecimal<T>;
/**
 ...
 */
export declare const rgb: <R extends number, G extends number, B extends number>(red: R, green: G, blue: B) => ColorRGB<R, G, B>;
/**
 ...
 */
export declare const rgba: <R extends number, G extends number, B extends number, A extends number>(red: R, green: G, blue: B, alpha: A) => ColorRGBA<R, G, B, A>;
/**
 ...
 */
export declare const hsl: <H extends number, S extends number, L extends number>(hue: H, saturation: S, lightness: L) => ColorHSL<H, S, L>;
/**
 * Represents a formatted HSL value.
 */
 ...
 */
export declare const hsla: <H extends number, S extends number, L extends number, A extends number>(hue: H, saturation: S, lightness: L, alpha: A) => ColorHSLA<H, S, L, A>;
/**
